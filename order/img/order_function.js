...
function getClinicName() {
	var sessionId = getCookie("PHPSESSID");
	requestByGET("http://localhost/mywebsite/php/select_client.php?PHPSESSID=" + sessionId, function(response){
...
// if (clientWidth <= 1280) {
// 	box.style.width = 1152 + "px";
// 	box.style.height = 560 + "px";
// }
// if (clientWidth >= 1550 && clientWidth <= 1920) {
// 	box.style.width = body.offsetWidth * 0.9 + "px";
// 	box.style.height = body.offsetHeight * 0.95 + "px";
// 	for (var i = 0; i < inputs.length; i ++) {
// 		if (inputs[i].type == "checkbox") {
// 			inputs[i].style.zoom = "120%";
// 		}
// 	}
// 	for (var i = 0; i < tds.length; i ++) {
// 		tds[i].style.fontSize = 1.2 + "rem";
// 		tds[i].style.lineHeight = 1.5 + "rem";
// 	}
// }
...
orderYear.value = currentYear;
orderMonth.value = currentMonth;
orderDay.value = currentDate;
orderHour.value = currentHour;
