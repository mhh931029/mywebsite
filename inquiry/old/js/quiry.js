	...
	success:function (data){
		...
		function createDiv(count){
			...
			for (var i = 0; i < count.length; i++) {
				...
				// console.log(data[count[i]].orderNumber);
				...
				boxDiv.onclick = function (){
					setCookie("orderNumber", this.orderNumber, 1);
					// removeCookie("name");
					window.location.href = "inquiry_details.html";
				}
...
$("#btn1").on("click",function (){
	window.location.href = "http://localhost/mywebsite/inquiry/Completed.html";
})
